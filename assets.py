...
about_blurbs = [
    ...
    "Never broke a bone, only hearts",
    "Isn't sure where South Africa is",
    "Voted most likely to remember every line from Austin Powers",
    "Thinks iphones are for babies"
]
pythodeck = [  
